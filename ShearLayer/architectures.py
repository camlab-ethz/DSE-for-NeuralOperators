...
class SpectralConv2d_UFNO(nn.Module):
    def __init__(self, in_channels, out_channels, modes1, modes2):
        super(SpectralConv2d_UFNO, self).__init__()
...
class UFNO(nn.Module):
    ...
    def __init__(self, modes1, modes2, width):
        ...
        self.fc0 = nn.Linear(3, self.width).to(torch.cfloat)
        self.conv0 = SpectralConv2d_UFNO(self.width, self.width, self.modes1, self.modes2)
        self.conv1 = SpectralConv2d_UFNO(self.width, self.width, self.modes1, self.modes2)
        self.conv2 = SpectralConv2d_UFNO(self.width, self.width, self.modes1, self.modes2)
        self.conv3 = SpectralConv2d_UFNO(self.width, self.width, self.modes1, self.modes2)
        self.conv4 = SpectralConv2d_UFNO(self.width, self.width, self.modes1, self.modes2)
        self.conv5 = SpectralConv2d_UFNO(self.width, self.width, self.modes1, self.modes2)
